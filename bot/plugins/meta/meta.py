...
class Meta(HandlerPlugin):
    def __init__(self, handler):
        ...
        self._event_methods["process_private_message"] += [self._private_message_reboot, self._private_message_help]

    def _private_message_reboot(self, message, handler_response=None):
    ...
    def _private_message_help(self, message, handler_response=None):
